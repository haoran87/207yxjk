    ...
    <div class="scroll-box">
      <div>
        ...
        <table class="altrowstable table-border number-font">
          <tr>
            <td class="altrowstable-left table-border table-title">告警名称</td>
            <td class="altrowstable-right table-border">{{ data.name }}</td>
            <td class="altrowstable-left table-border table-title">告警描述</td>
          ...
          <tr>
            ...
            <td class="altrowstable-left table-border table-title">模板状态</td>
            <td class="altrowstable-right table-border">
