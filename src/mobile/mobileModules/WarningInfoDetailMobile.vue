      ...
      <template slot-scope="{ boxHeight }">
        <div class="fixed-header">
          ...
          <div class="flex-center">
            <div style="margin-top: 0px; width: 90%; text-align: center">
              <tis-steps simple>
                <tis-step
        ...
        <div
          ...
          class="info-content"
          @scroll="scrollEvent"
          :style="{ height: boxHeight - 80 - 8 + 'px' }"
        >
          ...
          <div class="info-item" ref="warn_knowledge">
            ...
            <list-mobile :tableData="faultData" :tableObj="listObj">
...
import FaultLookMobile from "./FaultLookMobile.vue";
